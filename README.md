...
| @Service | Beans that are holding business logic, no other special use. <br>Can only be used on classes. <br>Special classes of @Component | [Here](https://github.com/goob8079/Dogs-Spring-Boot/blob/main/src/main/java/com/justice/dogs/account/MyUserDetailsService.java#L16-L17) |
